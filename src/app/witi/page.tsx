        ...
        >
            ...
            <div className="relative z-10" style={{ maxWidth: '860px', margin: '0 auto', padding: '4.5rem 2rem 3rem' }}>
                ...
                <motion.a
                    ...
                    className={`inline-flex items-center gap-2 text-[0.65rem] font-bold uppercase tracking-[0.3em] ${isDark ? "text-white/30 hover:text-white/60" : "text-black/30 hover:text-black/60"} transition-colors`}
                >
                ...
                <motion.div
                    ...
                    style={{ marginBottom: '2.5rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}
                >
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    style={{ marginTop: '3rem', paddingTop: '1.5rem', borderTop: isDark ? '1px solid rgba(255,255,255,0.08)' : '1px solid rgba(0,0,0,0.08)', textAlign: 'center' }}
                    className=""
                >
